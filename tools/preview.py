...
for(let i=0;i<3;i++){let y=62+29+i*42+21;if(theme=='Classic')skin(c,'ClassicPanel',12,y-12.5,25,25,3);glyph(c,ns[i],12.5,y-12,24,i==2);text(c,labels[i],42,y,10);skin(c,theme=='Classic'||i==2?'ToggleRed':'Toggle',111,y-9,34,18);text(c,i==2?'Aus':'An',128,y,10,'#ffd04b','center');
skin(c,'Toggle',155,y-4,98,8,2);c.fillStyle='#fab522';c.fillRect(158,y-1.5,92*vals[i]/100,3);draw(c,theme=='Classic'?'SilverThumb':'GoldThumb',155+88*vals[i]/100,y-9,10,18);text(c,vals[i]+' %',288,y,10,undefined,'right');if(i<2){c.fillStyle='#56514a';c.fillRect(14,y+21,272,.6)}}}
