...
de.TIP_COMPACT='Klick: an/aus · Rechtsklick: große Ansicht'
...
de.WHEEL_HELP='Mausrad: 5 % · Umschalt + Mausrad: 1 %'
en.AVOID_OVERLAP='Avoid overlap when placing'
de.AVOID_OVERLAP='Überlappung beim Ablegen vermeiden'
en.AVOID_HELP='On release, move to a free spot beside visible UI controls. Later-opening windows and inaccessible frames cannot be reserved.'
de.AVOID_HELP='Beim Loslassen einen freien Platz neben sichtbaren Bedienelementen suchen. Später geöffnete Fenster und nicht lesbare Bereiche lassen sich nicht freihalten.'
...
en.PLACEMENT_UNAVAILABLE='UI positions cannot be read in this client. Previous position restored.'
de.PLACEMENT_UNAVAILABLE='UI-Positionen sind in diesem Client nicht lesbar. Vorherige Position wiederhergestellt.'
en.CHANGES='What’s new';de.CHANGES='Neuerungen'
en.CHANGES_HELP='Click: short changelog';de.CHANGES_HELP='Klick: kurze Änderungsübersicht'
en.PREVIOUS='Previous';de.PREVIOUS='Zurück'
en.NEXT='Next';de.NEXT='Weiter'
