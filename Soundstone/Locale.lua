...
en.COMPARTMENT_HELP='Left-click: change view | Right-click: show/hide Soundstone'
de.COMPARTMENT_HELP='Linksklick: Ansicht wechseln | Rechtsklick: Soundstone ein/aus'
en.HIDDEN_COMPARTMENT='Hidden. Use /soundstone or the Addons menu below the clock to show it again.'
de.HIDDEN_COMPARTMENT='Ausgeblendet. Mit /soundstone oder über das Addons-Menü unter der Uhr wieder anzeigen.'
